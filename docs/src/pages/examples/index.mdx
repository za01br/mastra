...
<CardItems>
    ...
    links={[
      {
        ...
        href: "/examples/agents/agent-system-prompt",
      },
    ]}
  />
  <CardItem
  ...
  <CardItem
    ...
    links={[
      ...
      { title: "Building a RAG System with Mastra", href: "/examples/rag/basic-rag" },
      { title: "Building a RAG System with Mastra: Optimizing Information Density", href: "/examples/rag/cleanup-rag" },
      { title: "Building a RAG System with Mastra: Metadata Filtering", href: "/examples/rag/filter-rag" },
      { title: "Building a RAG System with Mastra: Chain of Thought Prompting", href: "/examples/rag/cot-rag" },
    ]}
  />
</CardItems>
