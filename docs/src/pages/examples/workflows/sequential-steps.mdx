...
<img src="/sequential-chains.png" alt="Diagram showing workflow with sequential steps" width={600} />
...
const stepThree = new Step({
  id: 'stepThree',
  execute: async ({ context: { machineContext } }) => ({
    tripledValue: machineContext.stepResults.stepTwo.result.incrementedValue * 3
  })
});
