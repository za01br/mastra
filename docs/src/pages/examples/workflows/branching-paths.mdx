...
const res = await branchedWorkflow.start({triggerData: { firstValue: 20 }});
...
<br />
<GithubLink
  link={'https://github.com/mastra-ai/mastra/blob/main/examples/basics/workflows/workflow-with-branching-paths'}
/>
