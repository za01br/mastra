...
export default async function GET(request: Request) {
  try {
    ...
    const title = hasTitle ? hasTitle?.slice(0, 100) : "Docs: Mastra";
    ...
    const date = hasDate ? hasDate : formattedDate;
    ...
    return new ImageResponse(
      (
        <div tw="relative h-full flex overflow-hidden bg-[#0a0a0a]">
          <svg
            style={{
              position: "absolute",
              top: 0,
          ...
          <div tw="relative flex h-full w-full flex-col p-8">
            ...
            <div tw="mt-8 flex flex-1 flex-col">
              <h1
                style={{
              ...
              <p
                ...
                tw="text-left -mt-4 text-[#939393] text-sm"
              >
                {date}
              </p>
            </div>

            <div tw="flex h-10 w-96 items-center rounded-lg bg-[#1a1a1a] px-4">
              <span
                style={{
