...
<PropertiesTable
  content={[
    ...
    },
    {
      name: '--port',
      type: 'number',
      description: 'Specifies the port number for the development server. Defaults to 4111.',
      isOptional: true,
    },
  ]}
/>
...
- [REST Endpoints Overview](/guide/local-dev/00-rest-endpoints.mdx) – More detailed usage of the dev server and agent endpoints.
- [mastra deploy](/guide/deployment/deployment.mdx) – Deploy your project to Vercel or Cloudflare.
