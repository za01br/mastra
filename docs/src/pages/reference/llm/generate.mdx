    ...
    },
    {
      ...
      properties: [
        ...
        },
        {
          ...
          isOptional: true,
          description: 'Callback function called when the generation is finished.',
        },
        {
          name: 'onStepFinish',
  ...
  content={[
    {
      ...
      type: 'string',
      isOptional: true,
      description: 'The generated text response. Present if `stream` is `false` and `schema` is not provided.',
    },
    {
      name: 'object',
      type: 'object',
