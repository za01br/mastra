...
- Check out our [Chain of Thought RAG Example](../examples/rag/cot-workflow-rag.mdx) for a hands-on tutorial
- I'll help you rewrite the RAG overview page following a similar structure. Here's the proposed rewrite:

# Retrieval-Augmented Generation (RAG) in Mastra
...
• Check out our [Chain of Thought RAG Example](../examples/rag/cot-workflow-rag.mdx) for a hands-on tutorial
• Explore the [RAG Examples](../../examples/rag) (including different chunking strategies, embedding models, and vector stores)
