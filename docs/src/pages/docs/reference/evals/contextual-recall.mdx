---
title: "Reference: Contextual Recall | Metrics | Mastra Evals Docs"
...
const result = await metric.measure({
  ...
  output: "The product includes cloud sync, offline mode, and multi-device support.",
  context: [
...
const result = await metric.measure({
  input: "Summarize the company's security measures",
  output: "The company implements encryption for data protection and requires 2FA for all users.",
  context: [
