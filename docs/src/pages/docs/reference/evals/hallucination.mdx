---
title: "Reference: Hallucination | Metrics | Mastra Evals Docs"
...
const result = await metric.measure({
  input: "Tell me about Tesla's founding.",
  output: "Tesla was founded in 2004 by Elon Musk in California.",
