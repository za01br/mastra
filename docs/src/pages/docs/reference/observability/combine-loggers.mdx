---
title: "Reference: combineLoggers() | Mastra Observability Docs"
description: Documentation for the combineLoggers function, which combines multiple logger instances into one.
---
