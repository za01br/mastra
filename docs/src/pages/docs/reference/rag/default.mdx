...
description: Documentation for the DefaultVectorDB class in Mastra, which provides vector search using LibSQL with vector extensions.
---

# DefaultVectorDB Store

The DefaultVectorDB class provides vector search using [LibSQL](https://github.com/tursodatabase/libsql), a fork of SQLite with vector extensions, and [Turso](https://turso.tech/) with vector extensions, offering a lightweight and efficient vector database solution.
