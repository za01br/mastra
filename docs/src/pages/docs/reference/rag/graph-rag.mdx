...
The `createGraphRAGTool()` creates a tool that enhances RAG by building a graph of semantic relationships between documents. It uses graph-based retrieval to find relevant content through both direct similarity and connected relationships.
