...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      type: "ExtractParams",
      isOptional: true,
      description: "Metadata extraction options (requires OpenAI API key). See ExtractParams section below.",
    },
  ]}
/>
  ...
  content={[
    {
      ...
      description: "Array of fields to extract from each chunk. Each field must include a name and description that guides the LLM's extraction.",
      isOptional: false
    },
    {
      name: "model",
