...
Mastra's CLI should be installed globally:
...
After initialization, you'll find a config file at `mastra/index.ts`. 

You can find the full list of configuration options in the [Mastra config docs](./reference/local-dev/mastra-config) and a reference of the files Mastra owns in the [Local File Structure docs](./reference/local-dev/project-structure).
