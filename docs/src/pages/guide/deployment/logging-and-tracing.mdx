...
- If you need to direct logs to multiple destinations—like both console and an external logging service—see the [combineLogger reference documentation](/guide/reference/observability/create-combinnedlogger.mdx).
