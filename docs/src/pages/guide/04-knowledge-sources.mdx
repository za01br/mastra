...
This splits the document into chunks and extracts metadata. For more details on chunking strategies and options, see the [MastraDocument reference documentation](#).
...
Alternatively, you can embed a single chunk:
