...
```typescript filename="mastra/agents/index.ts"
...
1. [Text generation](https://mastra.ai/docs/guide/reference/agents/text) (`agent.text()`)
2. [Streaming responses](https://mastra.ai/docs/guide/reference/agents/stream) (`agent.stream()`)
