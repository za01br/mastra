...
```ts showLineNumbers filename="index.ts" copy
...
Mastra also supports other providers through Portkey and AI SDK. Here are [Portkey docs](https://docs.portkey.ai/docs/custom-models) and [an example](https://github.com/mastra-ai/mastra/blob/main/examples/vnext/src/mastra/agents/test.ts). 
