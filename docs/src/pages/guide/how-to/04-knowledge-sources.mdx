...
Building custom agents and workflows requires both general knowledge (from base models) and domain- or user-specific knowledge, from specific documents, web scrapers, or data from internal SaaS.
...
Mastra supports all three approaches. It syncs data from your systems into a Postgres database, and then you can feed it directly into your agents or workflows, or vectorize it for RAG.
