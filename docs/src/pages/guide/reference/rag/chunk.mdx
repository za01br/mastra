  ...
  content={[
    {
      ...
      isOptional: true,
      description: "The chunking strategy to use. If not specified, defaults based on document type.",
    },
    {
      name: "options",
      type: "ChunkOptions",
...
Returns a `MastraDocument` instance containing the chunked documents. Each chunk includes:
