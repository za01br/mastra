...
Mastra supports a variety of language models from different providers, allowing you to choose the best fit for your application. These models are supported out of the box, providing a seamless integration experience. Below is a list of the models that Mastra currently supports.
...
While Mastra provides native support for popular LLM providers, you can also create custom model implementations for greater control and flexibility. This allows you to fine-tune the integration to your specific needs.
...
### Example: Custom Provider - Portkey

Another example of a custom provider is Portkey. You can refer to the [Portkey documentation](https://docs.portkey.ai/docs/custom-models) for more details on how to implement custom models. Additionally, you can find an example implementation in the [Mastra GitHub repository](https://github.com/mastra-ai/mastra/blob/main/examples/vnext/src/mastra/agents/test.ts).
