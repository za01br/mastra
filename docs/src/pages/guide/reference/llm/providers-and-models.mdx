...
Mastra supports a variety of language models from different providers. There are four types of models we support:
...
* **Custom providers through Portkey.** If a provider does not have an AI SDK integration, you can use them through the Portkey service.
...
Another example of a custom provider is Portkey. 
