  ...
  content={[
    {
      ...
      type: "Agent",
      description:
        "Returns an agent instance by name. Throws if agent not found.",
    ...
    },
    {
      ...
      type: "ToolApi",
      description:
        "Returns a tool instance by name with typed parameters. Throws if tool not found.",
    ...
    },
    {
      ...
      type: "Integration",
      description:
        "Returns an integration instance by name. Throws if integration not found.",
