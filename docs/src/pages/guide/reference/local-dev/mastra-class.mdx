...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      description: 'Custom tools to register',
      isOptional: true,
      defaultValue: '{}'
    },
    {
      name: 'integrations',
      type: 'Integration[]',
      description: 'Array of integrations to register',
      isOptional: true,
      defaultValue: '[]'
    },
    {
    ...
    },
    {
      ...
      description: 'Vector store instances',
      isOptional: true
    },
    {
      name: 'logger',
...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      type: 'void',
      description: 'Sets a logger for a specific component (AGENT | WORKFLOW).',
      example: 'mastra.setLogger({ key: "AGENT", logger });'
    },
    {
      name: 'getLogger(key)',
      type: 'Logger | undefined',
      description: 'Gets the logger for a specific component.',
