...
export const input_valueSchema = {
    anyOf: [
        ...
        },
        {
            ...
            required: ['line_1', 'line_2', 'line_3', 'line_4', 'locality', 'region', 'postcode', 'country_code', 'latitude', 'longitude'],
            additionalProperties: false
        },
        {
            type: 'object',
    ...
    anyOf: [
        ...
        },
        {
            ...
            properties: {
                ...
                currency_code: {
                    type: ['string', 'null'],
                    enum: ['EUR', 'GBP', 'USD', 'CAD', 'AUD', 'NZD', 'AED', 'INR', 'CHF', 'JPY', 'CNY', 'PHP', 'ILS', 'SGD', 'HKD', 'MYR', 'NTD', 'NOK', 'SEK', 'ISK', 'BEL', 'PLN', 'KRW', 'DKK', 'BRL'],
        ...
        },
        {
            ...
            required: ['original_email_address', 'email_address', 'email_domain', 'email_root_domain', 'email_local_specifier', 'attribute_type']
        },
        {
            type: 'object',
            properties: {
        ...
        },
        {
            ...
            required: ['line_1', 'line_2', 'line_3', 'line_4', 'locality', 'region', 'postcode', 'country_code', 'latitude', 'longitude', 'attribute_type'],
            additionalProperties: false
        },
        {
            type: 'object',
...
export const attributeSchema = {
    ...
    properties: {
        ...
        type: {
            type: 'string',
            enum: ['text', 'number', 'checkbox', 'currency', 'date', 'timestamp', 'rating', 'status', 'select', 'record-reference', 'actor-reference', 'location', 'domain', 'email-address', 'phone-number', 'interaction', 'personal-name'],
    ...
    required: ['id', 'title', 'description', 'api_slug', 'type', 'is_system_attribute', 'is_writable', 'is_required', 'is_unique', 'is_multiselect', 'is_default_value_enabled', 'is_archived', 'default_value', 'relationship', 'created_at', 'config'],
    example: {
        id: {
...
export const listSchema = {
    ...
    required: ['id', 'api_slug', 'name', 'parent_object', 'workspace_access', 'workspace_member_access', 'created_by_actor', 'created_at']
} as const;
...
export const commentSchema = {
    ...
    required: ['id', 'thread_id', 'content_plaintext', 'entry', 'record', 'resolved_at', 'resolved_by', 'created_at', 'author']
} as const;
...
export const taskSchema = {
    ...
    required: ['id', 'content_plaintext', 'deadline_at', 'is_completed', 'linked_records', 'assignees', 'created_by_actor', 'created_at']
} as const;
