...
export type IsLayerTrait = {
    ...
    boundVariables?: {
        ...
        fontFamily?: Array<VariableAlias>;
        fontSize?: Array<VariableAlias>;
        fontStyle?: Array<VariableAlias>;
        fontWeight?: Array<VariableAlias>;
        letterSpacing?: Array<VariableAlias>;
        lineHeight?: Array<VariableAlias>;
        paragraphSpacing?: Array<VariableAlias>;
        paragraphIndent?: Array<VariableAlias>;
        fills?: Array<VariableAlias>;
        strokes?: Array<VariableAlias>;
        componentProperties?: {
            [key: string]: VariableAlias;
        };
        textRangeFills?: Array<VariableAlias>;
        effects?: Array<VariableAlias>;
        layoutGrids?: Array<VariableAlias>;
    };
    /**
 ...
 * How layer should be treated when the frame is resized
 */
export type scrollBehavior = 'SCROLLS' | 'FIXED' | 'STICKY_SCROLLS';

export type HasChildrenTrait = {
    /**
     * An array of nodes that are direct children of this node
     */
    children: Array<SubcanvasNode>;
};
 ...
 * - `FILL`: only valid on auto-layout frame children
 */
export type layoutSizingHorizontal = 'FIXED' | 'HUG' | 'FILL';
 ...
 * - `FILL`: only valid on auto-layout frame children
 */
export type layoutSizingVertical = 'FIXED' | 'HUG' | 'FILL';
 ...
 * Whether a node has primary axis scrolling, horizontal or vertical.
 */
export type overflowDirection = 'HORIZONTAL_SCROLLING' | 'VERTICAL_SCROLLING' | 'HORIZONTAL_AND_VERTICAL_SCROLLING' | 'NONE';
 ...
 * Determines how the auto-layout frame’s wrapped tracks should be aligned in the counter axis direction. This property is only applicable for auto-layout frames with `layoutWrap: "WRAP"`.
 */
export type counterAxisAlignContent = 'AUTO' | 'SPACE_BETWEEN';
...
export type type = 'NONE' | 'READY_FOR_DEV' | 'COMPLETED';

export type FrameTraits = IsLayerTrait & HasBlendModeAndOpacityTrait & HasChildrenTrait & HasLayoutTrait & HasFramePropertiesTrait & CornerTrait & HasGeometryTrait & HasExportSettingsTrait & HasEffectsTrait & HasMaskTrait & TransitionSourceTrait & IndividualStrokesTrait & DevStatusTrait;
...
export type CanvasNode = {
     ...
     */
    flowStartingPoints: Array<FlowStartingPoint>;
    /**
 ...
 * The type of this node, represented by the string literal "BOOLEAN_OPERATION"
 */
export type type4 = 'BOOLEAN_OPERATION';
 ...
 * The type of this node, represented by the string literal "COMPONENT_SET"
 */
export type type9 = 'COMPONENT_SET';
 ...
 * The type of this node, represented by the string literal "REGULAR_POLYGON"
 */
export type type14 = 'REGULAR_POLYGON';
...
export type TextNode = {
     ...
     */
    type: 'TEXT';
} & DefaultShapeTraits & TypePropertiesTrait;

/**
 * The type of this node, represented by the string literal "TEXT"
 */
export type type16 = 'TEXT';
 ...
 * The type of this node, represented by the string literal "LINK_UNFURL"
 */
export type type22 = 'LINK_UNFURL';
 ...
 * The type of this node, represented by the string literal "SHAPE_WITH_TEXT"
 */
export type type24 = 'SHAPE_WITH_TEXT';
 ...
 * The type of this node, represented by the string literal "CONNECTOR"
 */
export type type25 = 'CONNECTOR';

/**
 * A string enum describing the end cap of the start of the connector.
 */
export type connectorStartStrokeCap = 'NONE' | 'LINE_ARROW' | 'TRIANGLE_ARROW' | 'DIAMOND_FILLED' | 'CIRCLE_FILLED' | 'TRIANGLE_FILLED';

/**
 * A string enum describing the end cap of the end of the connector.
 */
export type connectorEndStrokeCap = 'NONE' | 'LINE_ARROW' | 'TRIANGLE_ARROW' | 'DIAMOND_FILLED' | 'CIRCLE_FILLED' | 'TRIANGLE_FILLED';
...
export type type28 = 'NONE' | 'PRESET' | 'CUSTOM' | 'PRESENTATION';

export type rotation = 'NONE' | 'CCW_90';
 ...
 * - `HEIGHT`: Scale proportionally and set height to `value`.
 */
export type type29 = 'SCALE' | 'WIDTH' | 'HEIGHT';
...
export type format = 'JPG' | 'PNG' | 'SVG' | 'PDF';
 ...
 * The string literal representing the paint's type. Always check the `type` before reading other properties.
 */
export type type31 = 'GRADIENT_LINEAR' | 'GRADIENT_RADIAL' | 'GRADIENT_ANGULAR' | 'GRADIENT_DIAMOND';
 ...
 * - `SCALE`: Node scales vertically with containing frame
 */
export type vertical = 'TOP' | 'BOTTOM' | 'CENTER' | 'TOP_BOTTOM' | 'SCALE';
 ...
 * - `SCALE`: Node scales horizontally with containing frame
 */
export type horizontal = 'LEFT' | 'RIGHT' | 'CENTER' | 'LEFT_RIGHT' | 'SCALE';
 ...
 * - `GRID`: Square grid
 */
export type pattern = 'COLUMNS' | 'ROWS' | 'GRID';
 ...
 * - `CENTER`: Grid is center aligned
 */
export type alignment = 'MIN' | 'MAX' | 'STRETCH' | 'CENTER';
 ...
 * A string literal representing the effect's type. Always check the type before reading other properties.
 */
export type type33 = 'DROP_SHADOW';
 ...
 * A string literal representing the effect's type. Always check the type before reading other properties.
 */
export type type34 = 'INNER_SHADOW';
 ...
 * Text casing applied to the node, default is the original casing.
 */
export type textCase = 'UPPER' | 'LOWER' | 'TITLE' | 'SMALL_CAPS' | 'SMALL_CAPS_FORCED';
 ...
 * Indicates how the font weight was overridden when there is a text style override.
 */
export type semanticWeight = 'BOLD' | 'NORMAL';

/**
 * Indicates how the font style was overridden when there is a text style override.
 */
export type semanticItalic = 'ITALIC' | 'NORMAL';
 ...
 * Type of node for this preferred value.
 */
export type type36 = 'COMPONENT' | 'COMPONENT_SET';
...
export type type37 = 'VARIABLE_ALIAS';
...
export type type38 = 'ON_CLICK' | 'ON_HOVER' | 'ON_PRESS' | 'ON_DRAG';
...
export type type39 = 'AFTER_TIMEOUT';
...
export type type40 = 'ON_KEY_DOWN';

export type device = 'KEYBOARD' | 'XBOX_ONE' | 'PS4' | 'SWITCH_PRO' | 'UNKNOWN_CONTROLLER';
...
export type type41 = 'ON_MEDIA_HIT';
...
export type type44 = 'UPDATE_MEDIA_RUNTIME';

export type mediaAction = 'PLAY' | 'PAUSE' | 'TOGGLE_PLAY_PAUSE' | 'MUTE' | 'UNMUTE' | 'TOGGLE_MUTE_UNMUTE';
...
export type type46 = 'DISSOLVE' | 'SMART_ANIMATE' | 'SCROLL_ANIMATE';
...
export type type47 = 'MOVE_IN' | 'MOVE_OUT' | 'PUSH' | 'SLIDE_IN' | 'SLIDE_OUT';
...
export type type48 = 'SET_VARIABLE';
...
export type type49 = 'SET_VARIABLE_MODE';
...
export type ConditionalAction = {
    type: 'CONDITIONAL';
    conditionalBlocks: Array<ConditionalBlock>;
};

export type type50 = 'CONDITIONAL';
...
export type Expression = {
    ...
    expressionArguments: Array<VariableData>;
};
 ...
 * The corner of the comment region to pin to the node's corner as a string enum.
 */
export type comment_pin_corner = 'top-left' | 'top-right' | 'bottom-left' | 'bottom-right';
 ...
 */
export type WebhookV2Event = 'PING' | 'FILE_UPDATE' | 'FILE_VERSION_UPDATE' | 'FILE_DELETE' | 'LIBRARY_PUBLISH' | 'FILE_COMMENT';
...
export type event_type2 = 'FILE_UPDATE';
...
export type event_type3 = 'FILE_DELETE';
...
export type event_type4 = 'FILE_VERSION_UPDATE';
...
export type event_type5 = 'LIBRARY_PUBLISH';
...
export type event_type6 = 'FILE_COMMENT';
 ...
 * The type of entity.
 */
export type type52 = 'file';

/**
 * Indicates if the object is a file on Figma Design or FigJam.
 */
export type editor_type = 'figma' | 'figjam';

/**
 * Access policy for users who have the link to the file.
 */
export type link_access = 'view' | 'edit' | 'org_view' | 'org_edit' | 'inherit';

/**
 * Access policy for users who have the link to the file's prototype.
 */
export type proto_link_access = 'view' | 'org_view' | 'inherit';
 ...
 * - `TRIAL`: user is in the trial period for a subscription resource
 */
export type type60 = 'UNPAID' | 'PAID' | 'TRIAL';
 ...
 * The type of the resource.
 */
export type resource_type = 'PLUGIN' | 'WIDGET' | 'COMMUNITY_FILE';
 ...
 * - `EFFECT_COLOR`
 */
export type VariableScope = 'ALL_SCOPES' | 'TEXT_CONTENT' | 'CORNER_RADIUS' | 'WIDTH_HEIGHT' | 'GAP' | 'ALL_FILLS' | 'FRAME_FILL' | 'SHAPE_FILL' | 'TEXT_FILL' | 'STROKE_COLOR' | 'STROKE_FLOAT' | 'EFFECT_FLOAT' | 'EFFECT_COLOR' | 'OPACITY' | 'FONT_FAMILY' | 'FONT_STYLE' | 'FONT_WEIGHT' | 'FONT_SIZE' | 'LINE_HEIGHT' | 'LETTER_SPACING' | 'PARAGRAPH_SPACING' | 'PARAGRAPH_INDENT';
 ...
 * The resolved type of the variable.
 */
export type resolvedDataType = 'BOOLEAN' | 'FLOAT' | 'STRING' | 'COLOR';
...
export type GetFileError = ((ErrorResponsePayloadWithErrMessage & {
    /**
     * Status code
     */
    status: 400;
...
export type GetFileNodesError = ((ErrorResponsePayloadWithErrMessage & {
    /**
     * Status code
     */
    status: 400;
...
export type GetImagesError = ((ErrorResponsePayloadWithErrMessage & {
    /**
     * Status code
     */
    status: 400;
...
export type GetImageFillsError = ((ErrorResponsePayloadWithErrMessage & {
    /**
     * Status code
     */
    status: 400;
...
export type GetTeamProjectsData = {
    path: {
        /**
...
export type GetTeamProjectsError = ((ErrorResponsePayloadWithErrorBoolean & {
    /**
     * Status code
     */
    status: 400;
...
export type GetProjectFilesError = ((ErrorResponsePayloadWithErrorBoolean & {
    /**
     * Status code
     */
    status: 400;
...
export type GetFileVersionsError = ((ErrorResponsePayloadWithErrMessage & {
    /**
     * Status code
     */
    status: 403;
...
export type GetCommentsError = ((ErrorResponsePayloadWithErrMessage & {
    /**
     * Status code
     */
    status: 403;
...
export type PostCommentError = ((ErrorResponsePayloadWithErrorBoolean & {
    /**
     * Status code
     */
    status: 400;
...
export type DeleteCommentError = ((ErrorResponsePayloadWithErrMessage & {
    /**
     * Status code
     */
    status: 403;
...
export type GetCommentReactionsData = {
    path: {
        /**
...
export type GetCommentReactionsError = ((ErrorResponsePayloadWithErrMessage & {
    /**
     * Status code
     */
    status: 403;
...
export type PostCommentReactionData = {
    /**
     * Reaction to post.
     */
    body: {
...
export type PostCommentReactionError = ((ErrorResponsePayloadWithErrorBoolean & {
    /**
     * Status code
     */
    status: 400;
...
export type DeleteCommentReactionError = ((ErrorResponsePayloadWithErrMessage & {
    /**
     * Status code
     */
    status: 403;
...
export type GetMeError = ((ErrorResponsePayloadWithErrMessage & {
    /**
     * Status code
     */
    status: 403;
...
export type GetTeamComponentsData = {
    path: {
        /**
...
export type GetTeamComponentsResponse = ({
    ...
    error: boolean;
    meta: {
        components: Array<PublishedComponent>;
        cursor?: ResponseCursor;
    };
});

export type GetTeamComponentsError = ((ErrorResponsePayloadWithErrMessage & {
    /**
     * Status code
     */
    status: 400;
...
export type GetFileComponentsData = {
    path: {
        /**
...
export type GetFileComponentsError = ((ErrorResponsePayloadWithErrMessage & {
    /**
     * Status code
     */
    status: 400;
...
export type GetComponentError = ((ErrorResponsePayloadWithErrMessage & {
    /**
     * Status code
     */
    status: 400;
...
export type GetTeamComponentSetsData = {
    path: {
        /**
...
export type GetTeamComponentSetsResponse = ({
    ...
    error: boolean;
    meta: {
        component_sets: Array<PublishedComponentSet>;
        cursor?: ResponseCursor;
    };
});

export type GetTeamComponentSetsError = ((ErrorResponsePayloadWithErrMessage & {
    /**
     * Status code
     */
    status: 400;
...
export type GetFileComponentSetsData = {
    path: {
        /**
...
export type GetFileComponentSetsError = ((ErrorResponsePayloadWithErrMessage & {
    /**
     * Status code
     */
    status: 400;
...
export type GetComponentSetData = {
    path: {
        /**
...
export type GetComponentSetError = ((ErrorResponsePayloadWithErrMessage & {
    /**
     * Status code
     */
    status: 400;
...
export type GetTeamStylesResponse = ({
    ...
    error: boolean;
    meta: {
        styles: Array<PublishedStyle>;
        cursor?: ResponseCursor;
    };
});

export type GetTeamStylesError = ((ErrorResponsePayloadWithErrMessage & {
    /**
     * Status code
     */
    status: 400;
...
export type GetFileStylesError = ((ErrorResponsePayloadWithErrMessage & {
    /**
     * Status code
     */
    status: 400;
...
export type GetStyleError = ((ErrorResponsePayloadWithErrMessage & {
    /**
     * Status code
     */
    status: 400;
...
export type PostWebhookError = ((ErrorResponsePayloadWithErrorBoolean & {
    /**
     * Status code
     */
    status: 400;
...
export type GetWebhookError = ((ErrorResponsePayloadWithErrorBoolean & {
    /**
     * Status code
     */
    status: 400;
...
export type PutWebhookError = ((ErrorResponsePayloadWithErrorBoolean & {
    /**
     * Status code
     */
    status: 400;
...
export type DeleteWebhookError = ((ErrorResponsePayloadWithErrorBoolean & {
    /**
     * Status code
     */
    status: 400;
...
export type GetTeamWebhooksData = {
    path: {
        /**
...
export type GetTeamWebhooksResponse = ({
     ...
     */
    webhooks: Array<WebhookV2>;
});

export type GetTeamWebhooksError = ((ErrorResponsePayloadWithErrMessage & {
    /**
     * Status code
     */
    status: 403;
...
export type GetWebhookRequestsData = {
    path: {
        /**
...
export type GetWebhookRequestsResponse = ({
     ...
     */
    requests: Array<WebhookV2Request>;
});

export type GetWebhookRequestsError = ((ErrorResponsePayloadWithErrorBoolean & {
    /**
     * Status code
     */
    status: 400;
...
export type GetActivityLogsResponse = ({
    ...
    meta?: {
         ...
         */
        activity_logs?: Array<ActivityLog>;
        /**
...
export type GetActivityLogsError = ((ErrorResponsePayloadWithErrorBoolean & {
    /**
     * Status code
     */
    status: 400;
...
export type GetPaymentsError = ((ErrorResponsePayloadWithErrorBoolean & {
    /**
     * Status code
     */
    status: 401;
...
export type GetLocalVariablesData = {
    path: {
        /**
...
export type GetLocalVariablesResponse = ({
    ...
    meta: {
         ...
         */
        variableCollections: {
            [key: string]: LocalVariableCollection;
        };
    };
});

export type GetLocalVariablesError = ((ErrorResponsePayloadWithErrorBoolean & {
    /**
     * Status code
     */
    status: 401;
...
export type GetPublishedVariablesData = {
    path: {
        /**
...
export type GetPublishedVariablesResponse = ({
    ...
    meta: {
         ...
         */
        variables: {
            [key: string]: PublishedVariable;
        };
        /**
         * A map of variable collection ids to variable collections
         */
        variableCollections: {
            [key: string]: PublishedVariableCollection;
        };
    };
});

export type GetPublishedVariablesError = ((ErrorResponsePayloadWithErrorBoolean & {
    /**
     * Status code
     */
    status: 401;
...
export type PostVariablesError = ((ErrorResponsePayloadWithErrorBoolean & {
    /**
     * Status code
     */
    status: 400;
...
export type GetDevResourcesData = {
    path: {
        /**
...
export type GetDevResourcesResponse = ({
     ...
     */
    dev_resources: Array<DevResource>;
});

export type GetDevResourcesError = ((ErrorResponsePayloadWithErrorBoolean & {
    /**
     * Status code
     */
    status: 400;
...
export type PostDevResourcesData = {
    /**
...
export type PostDevResourcesResponse = ({
     ...
     */
    links_created: Array<DevResource>;
    /**
     * An array of errors.
     */
    errors?: Array<{
...
export type PostDevResourcesError = ((ErrorResponsePayloadWithErrorBoolean & {
    /**
     * Status code
     */
    status: 400;
...
export type PutDevResourcesData = {
    /**
...
export type PutDevResourcesResponse = ({
     ...
     */
    links_updated?: Array<DevResource>;
    /**
     * An array of errors.
     */
    errors?: Array<{
...
export type PutDevResourcesError = ((ErrorResponsePayloadWithErrorBoolean & {
    /**
     * Status code
     */
    status: 400;
...
export type DeleteDevResourceData = {
    path: {
        /**
...
export type DeleteDevResourceResponse = (unknown);

export type DeleteDevResourceError = ((ErrorResponsePayloadWithErrorBoolean & {
    /**
     * Status code
     */
    status: 401;
...
export type GetLibraryAnalyticsActionsData = {
    path: {
        /**
...
export type GetLibraryAnalyticsActionsResponse = ({
     ...
     */
    rows: (Array<LibraryAnalyticsActionsByComponent> | Array<LibraryAnalyticsActionsByTeam>);
    /**
...
export type GetLibraryAnalyticsActionsError = ((ErrorResponsePayloadWithErrorBoolean & {
    /**
     * Status code
     */
    status: 400;
...
export type GetLibraryAnalyticsUsagesData = {
    path: {
        /**
         * File key of the library to fetch analytics data for.
         */
...
export type GetLibraryAnalyticsUsagesResponse = ({
     ...
     */
    components?: Array<LibraryAnalyticsUsagesByComponent>;
    /**
     * An array of analytics data when breaking down usage by file.
     */
    files?: Array<LibraryAnalyticsUsagesByFile>;
    /**
     * Whether there is a next page of data that can be fetched.
     */
    next_page: boolean;
...
export type GetLibraryAnalyticsUsagesError = ((ErrorResponsePayloadWithErrorBoolean & {
    /**
     * Status code
     */
    status: 400;
