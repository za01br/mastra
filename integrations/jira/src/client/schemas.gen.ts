...
export const JiraExpressionForAnalysisSchema = {
  ...
  properties: {
    contextVariables: {
      additionalProperties: {
        description:
          'Context variables and their types. The type checker assumes that <a href="https://developer.atlassian.com/cloud/jira/platform/jira-expressions/#context-variables">common context variables</a>, such as <code>issue</code> or <code>project</code>, are available in context and sets their type. Use this property to override the default types or provide details of new variables.',
        type: 'string',
      },
      description:
...
export const WebhookSchema = {
  ...
  properties: {
    ...
    fieldIdsFilter: {
      ...
      items: {
        description:
          'A list of field IDs. When the issue changelog contains any of the fields, the webhook <code>jira:issue_updated</code> is sent. If this parameter is not present, the app is notified about all field updates.',
        type: 'string',
      },
      type: 'array',
    },
    ...
    issuePropertyKeysFilter: {
      ...
      items: {
        description:
          'A list of issue property keys. A change of those issue properties triggers the <code>issue_property_set</code> or <code>issue_property_deleted</code> webhooks. If this parameter is not present, the app is notified about all issue property updates.',
        type: 'string',
      },
      type: 'array',
    },
