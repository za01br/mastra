...
import type { ApiKeyGetInfoData, ApiKeyGetInfoError, ApiKeyGetInfoResponse2, ApplicationChangeSourceData, ApplicationChangeSourceError, ApplicationChangeSourceResponse2, ApplicationChangeStageData, ApplicationChangeStageError, ApplicationChangeStageResponse2, ApplicationConsiderCandidateData, ApplicationConsiderCandidateError, ApplicationConsiderCandidateResponse2, ApplicationGetDetailsData, ApplicationGetDetailsError, ApplicationGetDetailsResponse2, ApplicationGetAllSchedulesData, ApplicationGetAllSchedulesError, ApplicationGetAllSchedulesResponse2, ApplicationFeedbackListAllData, ApplicationFeedbackListAllError, ApplicationFeedbackListAllResponse2, ApplicationFeedbackSubmitFeedbackData, ApplicationFeedbackSubmitFeedbackError, ApplicationFeedbackSubmitFeedbackResponse2, ApplicationFormSubmitFormData, ApplicationFormSubmitFormError, ApplicationFormSubmitFormResponse2, ApprovalDefinitionUpdateEntityScopeData, ApprovalDefinitionUpdateEntityScopeError, ApprovalDefinitionUpdateEntityScopeResponse2, ArchiveReasonListData, ArchiveReasonListError, ArchiveReasonListResponse2, AssessmentAddCompletedToCandidateData, AssessmentAddCompletedToCandidateError, AssessmentAddCompletedToCandidateResponse2, AssessmentPartnerStartData, AssessmentPartnerStartError, AssessmentPartnerStartResponse2, AssessmentListPartnerSupportError, AssessmentListPartnerSupportResponse2, AssessmentUpdateStatusData, AssessmentUpdateStatusError, AssessmentUpdateStatusResponse2, AssessmentCancelPartnerAssessmentData, AssessmentCancelPartnerAssessmentError, AssessmentCancelPartnerAssessmentResponse2, CandidateAddTagData, CandidateAddTagError, CandidateAddTagResponse2, CandidateAnonymizeCandidateData, CandidateAnonymizeCandidateError, CandidateAnonymizeCandidateResponse2, CandidateCreateNewCandidateData, CandidateCreateNewCandidateError, CandidateCreateNewCandidateResponse2, CandidateCreateNoteData, CandidateCreateNoteError, CandidateCreateNoteResponse2, CandidateGetByIdData, CandidateGetByIdError, CandidateGetByIdResponse2, CandidateListAllData, CandidateListAllError, CandidateListAllResponse2, CandidateGetAllNotesData, CandidateGetAllNotesError, CandidateGetAllNotesResponse2, CandidateSearchByEmailAndNameData, CandidateSearchByEmailAndNameError, CandidateSearchByEmailAndNameResponse2, CandidateUpdateExistingCandidateData, CandidateUpdateExistingCandidateError, CandidateUpdateExistingCandidateResponse2, CandidateAttachFileData, CandidateAttachFileError, CandidateAttachFileResponse2, CandidateUploadResumeDataData, CandidateUploadResumeDataError, CandidateUploadResumeDataResponse2, CandidateTagCreateNewTagData, CandidateTagCreateNewTagError, CandidateTagCreateNewTagResponse2, CandidateTagListAllData, CandidateTagListAllError, CandidateTagListAllResponse2, CustomFieldCreateNewFieldData, CustomFieldCreateNewFieldError, CustomFieldCreateNewFieldResponse2, CustomFieldGetAllData, CustomFieldGetAllError, CustomFieldGetAllResponse2, CustomFieldSetValueData, CustomFieldSetValueError, CustomFieldSetValueResponse2, DepartmentTeamCreateNewDepartmentData, DepartmentTeamCreateNewDepartmentError, DepartmentTeamCreateNewDepartmentResponse2, DepartmentGetByIdData, DepartmentGetByIdError, DepartmentGetByIdResponse2, DepartmentGetAllDepartmentsData, DepartmentGetAllDepartmentsError, DepartmentGetAllDepartmentsResponse2, FileGetUrlCandidateData, FileGetUrlCandidateError, FileGetUrlCandidateResponse2, FeedbackFormDefinitionGetByIdData, FeedbackFormDefinitionGetByIdError, FeedbackFormDefinitionGetByIdResponse2, FeedbackFormDefinitionListAllData, FeedbackFormDefinitionListAllError, FeedbackFormDefinitionListAllResponse2, HiringTeamAddMemberData, HiringTeamAddMemberError, HiringTeamAddMemberResponse2, HiringTeamRoleListRolesData, HiringTeamRoleListRolesError, HiringTeamRoleListRolesResponse2, InterviewGetByIdData, InterviewGetByIdError, InterviewGetByIdResponse2, InterviewGetAllData, InterviewGetAllError, InterviewGetAllResponse2, InterviewEventListAssociatedEventsData, InterviewEventListAssociatedEventsError, InterviewEventListAssociatedEventsResponse2, InterviewPlanGetAllData, InterviewPlanGetAllError, InterviewPlanGetAllResponse2, InterviewScheduleCancelByIdData, InterviewScheduleCancelByIdError, InterviewScheduleCancelByIdResponse2, InterviewScheduleCreateScheduledInterviewData, InterviewScheduleCreateScheduledInterviewError, InterviewScheduleCreateScheduledInterviewResponse2, InterviewScheduleGetAllSchedulesData, InterviewScheduleGetAllSchedulesError, InterviewScheduleGetAllSchedulesResponse2, InterviewScheduleUpdateEventData, InterviewScheduleUpdateEventError, InterviewScheduleUpdateEventResponse2, InterviewStageListAllInOrderData, InterviewStageListAllInOrderError, InterviewStageListAllInOrderResponse2, InterviewStageGetByIdData, InterviewStageGetByIdError, InterviewStageGetByIdResponse2, JobNewCreateData, JobNewCreateError, JobNewCreateResponse2, JobGetByIdData, JobGetByIdError, JobGetByIdResponse2, JobGetListData, JobGetListError, JobGetListResponse2, JobSetStatusByIdData, JobSetStatusByIdError, JobSetStatusByIdResponse2, JobUpdateExistingData, JobUpdateExistingError, JobUpdateExistingResponse2, JobSearchByTitleData, JobSearchByTitleError, JobSearchByTitleResponse2, JobInterviewPlanGetInfoData, JobInterviewPlanGetInfoError, JobInterviewPlanGetInfoResponse2, JobPostingGetIndividualData, JobPostingGetIndividualError, JobPostingGetIndividualResponse2, JobPostingGetAllPublishedData, JobPostingGetAllPublishedError, JobPostingGetAllPublishedResponse2, JobPostingUpdateExistingData, JobPostingUpdateExistingError, JobPostingUpdateExistingResponse2, LocationCreateHierarchyData, LocationCreateHierarchyError, LocationCreateHierarchyResponse2, LocationDetailsByIdData, LocationDetailsByIdError, LocationDetailsByIdResponse2, LocationGetListData, LocationGetListError, LocationGetListResponse2, OfferCreateNewData, OfferCreateNewError, OfferCreateNewResponse2, OfferGetDetailsByIdData, OfferGetDetailsByIdError, OfferGetDetailsByIdResponse2, OfferGetListData, OfferGetListError, OfferGetListResponse2, OfferStartCreationInstanceData, OfferStartCreationInstanceError, OfferStartCreationInstanceResponse2, OfferProcessStartProcessForCandidateData, OfferProcessStartProcessForCandidateError, OfferProcessStartProcessForCandidateResponse2, OpeningsGetByUuidData, OpeningsGetByUuidError, OpeningsGetByUuidResponse2, OpeningsGetListData, OpeningsGetListError, OpeningsGetListResponse2, OpeningsSearchByIdentifierData, OpeningsSearchByIdentifierError, OpeningsSearchByIdentifierResponse2, OpeningsCreateInstanceData, OpeningsCreateInstanceError, OpeningsCreateInstanceResponse2, OpeningsAddJobActionData, OpeningsAddJobActionError, OpeningsAddJobActionResponse2, OpeningsRemoveJobData, OpeningsRemoveJobError, OpeningsRemoveJobResponse2, OpeningsSetStateData, OpeningsSetStateError, OpeningsSetStateResponse2, OpeningsSetArchivedData, OpeningsSetArchivedError, OpeningsSetArchivedResponse2, OpeningsUpdateOpeningData, OpeningsUpdateOpeningError, OpeningsUpdateOpeningResponse2, ReferralCreateNewData, ReferralCreateNewError, ReferralCreateNewResponse2, ReferralFormGetDefaultFormError, ReferralFormGetDefaultFormResponse2, SourceGetAllData, SourceGetAllError, SourceGetAllResponse2, SurveyFormDefinitionGetDetailsByIdData, SurveyFormDefinitionGetDetailsByIdError, SurveyFormDefinitionGetDetailsByIdResponse2, SurveyFormDefinitionGetAllData, SurveyFormDefinitionGetAllError, SurveyFormDefinitionGetAllResponse2, SurveyRequestGenerateUrlData, SurveyRequestGenerateUrlError, SurveyRequestGenerateUrlResponse2, SurveySubmissionListBySurveyTypeData, SurveySubmissionListBySurveyTypeError, SurveySubmissionListBySurveyTypeResponse2, UserGetByIdData, UserGetByIdError, UserGetByIdResponse2, UserGetAshbyUsersData, UserGetAshbyUsersError, UserGetAshbyUsersResponse2, UserSearchByEmailData, UserSearchByEmailError, UserSearchByEmailResponse2, WebhookCreateSettingData, WebhookCreateSettingError, WebhookCreateSettingResponse2, WebhookUpdateSettingData, WebhookUpdateSettingError, WebhookUpdateSettingResponse2, WebhookRemoveSettingData, WebhookRemoveSettingError, WebhookRemoveSettingResponse2 } from './types.gen';
 ...
 *
 */
export const apiKeyGetInfo = <ThrowOnError extends boolean = false>(options?: Options<ApiKeyGetInfoData, ThrowOnError>) => {
 ...
 *
 */
export const applicationChangeSource = <ThrowOnError extends boolean = false>(options?: Options<ApplicationChangeSourceData, ThrowOnError>) => {
 ...
 *
 */
export const applicationChangeStage = <ThrowOnError extends boolean = false>(options?: Options<ApplicationChangeStageData, ThrowOnError>) => {
 ...
 *
 */
export const applicationConsiderCandidate = <ThrowOnError extends boolean = false>(options?: Options<ApplicationConsiderCandidateData, ThrowOnError>) => {
    return (options?.client ?? client).post<ApplicationConsiderCandidateResponse2, ApplicationConsiderCandidateError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const applicationGetDetails = <ThrowOnError extends boolean = false>(options?: Options<ApplicationGetDetailsData, ThrowOnError>) => {
 ...
 *
 */
export const applicationGetAllSchedules = <ThrowOnError extends boolean = false>(options?: Options<ApplicationGetAllSchedulesData, ThrowOnError>) => {
    return (options?.client ?? client).post<ApplicationGetAllSchedulesResponse2, ApplicationGetAllSchedulesError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const applicationFeedbackListAll = <ThrowOnError extends boolean = false>(options?: Options<ApplicationFeedbackListAllData, ThrowOnError>) => {
    return (options?.client ?? client).post<ApplicationFeedbackListAllResponse2, ApplicationFeedbackListAllError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const applicationFeedbackSubmitFeedback = <ThrowOnError extends boolean = false>(options?: Options<ApplicationFeedbackSubmitFeedbackData, ThrowOnError>) => {
    return (options?.client ?? client).post<ApplicationFeedbackSubmitFeedbackResponse2, ApplicationFeedbackSubmitFeedbackError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const applicationFormSubmitForm = <ThrowOnError extends boolean = false>(options?: Options<ApplicationFormSubmitFormData, ThrowOnError>) => {
    return (options?.client ?? client).post<ApplicationFormSubmitFormResponse2, ApplicationFormSubmitFormError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const approvalDefinitionUpdateEntityScope = <ThrowOnError extends boolean = false>(options?: Options<ApprovalDefinitionUpdateEntityScopeData, ThrowOnError>) => {
    return (options?.client ?? client).post<ApprovalDefinitionUpdateEntityScopeResponse2, ApprovalDefinitionUpdateEntityScopeError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const archiveReasonList = <ThrowOnError extends boolean = false>(options?: Options<ArchiveReasonListData, ThrowOnError>) => {
 ...
 *
 */
export const assessmentAddCompletedToCandidate = <ThrowOnError extends boolean = false>(options?: Options<AssessmentAddCompletedToCandidateData, ThrowOnError>) => {
    return (options?.client ?? client).post<AssessmentAddCompletedToCandidateResponse2, AssessmentAddCompletedToCandidateError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const assessmentPartnerStart = <ThrowOnError extends boolean = false>(options?: Options<AssessmentPartnerStartData, ThrowOnError>) => {
 ...
 *
 */
export const assessmentListPartnerSupport = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
    return (options?.client ?? client).post<AssessmentListPartnerSupportResponse2, AssessmentListPartnerSupportError, ThrowOnError>({
        ...options,
        url: '/assessment.list'
    });
};
 ...
 *
 */
export const assessmentUpdateStatus = <ThrowOnError extends boolean = false>(options?: Options<AssessmentUpdateStatusData, ThrowOnError>) => {
 ...
 *
 */
export const assessmentCancelPartnerAssessment = <ThrowOnError extends boolean = false>(options?: Options<AssessmentCancelPartnerAssessmentData, ThrowOnError>) => {
    return (options?.client ?? client).post<AssessmentCancelPartnerAssessmentResponse2, AssessmentCancelPartnerAssessmentError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const candidateAddTag = <ThrowOnError extends boolean = false>(options?: Options<CandidateAddTagData, ThrowOnError>) => {
 ...
 *
 */
export const candidateAnonymizeCandidate = <ThrowOnError extends boolean = false>(options?: Options<CandidateAnonymizeCandidateData, ThrowOnError>) => {
    return (options?.client ?? client).post<CandidateAnonymizeCandidateResponse2, CandidateAnonymizeCandidateError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const candidateCreateNewCandidate = <ThrowOnError extends boolean = false>(options?: Options<CandidateCreateNewCandidateData, ThrowOnError>) => {
    return (options?.client ?? client).post<CandidateCreateNewCandidateResponse2, CandidateCreateNewCandidateError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const candidateCreateNote = <ThrowOnError extends boolean = false>(options?: Options<CandidateCreateNoteData, ThrowOnError>) => {
 ...
 *
 */
export const candidateGetById = <ThrowOnError extends boolean = false>(options: Options<CandidateGetByIdData, ThrowOnError>) => {
 ...
 *
 */
export const candidateListAll = <ThrowOnError extends boolean = false>(options?: Options<CandidateListAllData, ThrowOnError>) => {
 ...
 *
 */
export const candidateGetAllNotes = <ThrowOnError extends boolean = false>(options?: Options<CandidateGetAllNotesData, ThrowOnError>) => {
 ...
 *
 */
export const candidateSearchByEmailAndName = <ThrowOnError extends boolean = false>(options?: Options<CandidateSearchByEmailAndNameData, ThrowOnError>) => {
    return (options?.client ?? client).post<CandidateSearchByEmailAndNameResponse2, CandidateSearchByEmailAndNameError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const candidateUpdateExistingCandidate = <ThrowOnError extends boolean = false>(options?: Options<CandidateUpdateExistingCandidateData, ThrowOnError>) => {
    return (options?.client ?? client).post<CandidateUpdateExistingCandidateResponse2, CandidateUpdateExistingCandidateError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const candidateAttachFile = <ThrowOnError extends boolean = false>(options: Options<CandidateAttachFileData, ThrowOnError>) => {
 ...
 *
 */
export const candidateUploadResumeData = <ThrowOnError extends boolean = false>(options: Options<CandidateUploadResumeDataData, ThrowOnError>) => {
    return (options?.client ?? client).post<CandidateUploadResumeDataResponse2, CandidateUploadResumeDataError, ThrowOnError>({
        ...options,
        ...formDataBodySerializer,
        headers: {
            'Content-Type': null,
 ...
 *
 */
export const candidateTagCreateNewTag = <ThrowOnError extends boolean = false>(options?: Options<CandidateTagCreateNewTagData, ThrowOnError>) => {
    return (options?.client ?? client).post<CandidateTagCreateNewTagResponse2, CandidateTagCreateNewTagError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const candidateTagListAll = <ThrowOnError extends boolean = false>(options?: Options<CandidateTagListAllData, ThrowOnError>) => {
 ...
 *
 */
export const customFieldCreateNewField = <ThrowOnError extends boolean = false>(options?: Options<CustomFieldCreateNewFieldData, ThrowOnError>) => {
    return (options?.client ?? client).post<CustomFieldCreateNewFieldResponse2, CustomFieldCreateNewFieldError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const customFieldGetAll = <ThrowOnError extends boolean = false>(options?: Options<CustomFieldGetAllData, ThrowOnError>) => {
 ...
 *
 */
export const customFieldSetValue = <ThrowOnError extends boolean = false>(options?: Options<CustomFieldSetValueData, ThrowOnError>) => {
 ...
 *
 */
export const departmentTeamCreateNewDepartment = <ThrowOnError extends boolean = false>(options?: Options<DepartmentTeamCreateNewDepartmentData, ThrowOnError>) => {
    return (options?.client ?? client).post<DepartmentTeamCreateNewDepartmentResponse2, DepartmentTeamCreateNewDepartmentError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const departmentGetById = <ThrowOnError extends boolean = false>(options?: Options<DepartmentGetByIdData, ThrowOnError>) => {
 ...
 *
 */
export const departmentGetAllDepartments = <ThrowOnError extends boolean = false>(options?: Options<DepartmentGetAllDepartmentsData, ThrowOnError>) => {
    return (options?.client ?? client).post<DepartmentGetAllDepartmentsResponse2, DepartmentGetAllDepartmentsError, ThrowOnError>({
        ...options,
        url: '/department.list'
    });
};
 ...
 *
 */
export const fileGetUrlCandidate = <ThrowOnError extends boolean = false>(options?: Options<FileGetUrlCandidateData, ThrowOnError>) => {
 ...
 *
 */
export const feedbackFormDefinitionGetById = <ThrowOnError extends boolean = false>(options?: Options<FeedbackFormDefinitionGetByIdData, ThrowOnError>) => {
    return (options?.client ?? client).post<FeedbackFormDefinitionGetByIdResponse2, FeedbackFormDefinitionGetByIdError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const feedbackFormDefinitionListAll = <ThrowOnError extends boolean = false>(options?: Options<FeedbackFormDefinitionListAllData, ThrowOnError>) => {
    return (options?.client ?? client).post<FeedbackFormDefinitionListAllResponse2, FeedbackFormDefinitionListAllError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const hiringTeamAddMember = <ThrowOnError extends boolean = false>(options?: Options<HiringTeamAddMemberData, ThrowOnError>) => {
 ...
 *
 */
export const hiringTeamRoleListRoles = <ThrowOnError extends boolean = false>(options?: Options<HiringTeamRoleListRolesData, ThrowOnError>) => {
 ...
 *
 */
export const interviewGetById = <ThrowOnError extends boolean = false>(options?: Options<InterviewGetByIdData, ThrowOnError>) => {
 ...
 *
 */
export const interviewGetAll = <ThrowOnError extends boolean = false>(options?: Options<InterviewGetAllData, ThrowOnError>) => {
 ...
 *
 */
export const interviewEventListAssociatedEvents = <ThrowOnError extends boolean = false>(options?: Options<InterviewEventListAssociatedEventsData, ThrowOnError>) => {
    return (options?.client ?? client).post<InterviewEventListAssociatedEventsResponse2, InterviewEventListAssociatedEventsError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const interviewPlanGetAll = <ThrowOnError extends boolean = false>(options?: Options<InterviewPlanGetAllData, ThrowOnError>) => {
 ...
 *
 */
export const interviewScheduleCancelById = <ThrowOnError extends boolean = false>(options?: Options<InterviewScheduleCancelByIdData, ThrowOnError>) => {
    return (options?.client ?? client).post<InterviewScheduleCancelByIdResponse2, InterviewScheduleCancelByIdError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const interviewScheduleCreateScheduledInterview = <ThrowOnError extends boolean = false>(options?: Options<InterviewScheduleCreateScheduledInterviewData, ThrowOnError>) => {
    return (options?.client ?? client).post<InterviewScheduleCreateScheduledInterviewResponse2, InterviewScheduleCreateScheduledInterviewError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const interviewScheduleGetAllSchedules = <ThrowOnError extends boolean = false>(options?: Options<InterviewScheduleGetAllSchedulesData, ThrowOnError>) => {
    return (options?.client ?? client).post<InterviewScheduleGetAllSchedulesResponse2, InterviewScheduleGetAllSchedulesError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const interviewScheduleUpdateEvent = <ThrowOnError extends boolean = false>(options?: Options<InterviewScheduleUpdateEventData, ThrowOnError>) => {
    return (options?.client ?? client).post<InterviewScheduleUpdateEventResponse2, InterviewScheduleUpdateEventError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const interviewStageListAllInOrder = <ThrowOnError extends boolean = false>(options?: Options<InterviewStageListAllInOrderData, ThrowOnError>) => {
    return (options?.client ?? client).post<InterviewStageListAllInOrderResponse2, InterviewStageListAllInOrderError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const interviewStageGetById = <ThrowOnError extends boolean = false>(options?: Options<InterviewStageGetByIdData, ThrowOnError>) => {
 ...
 *
 */
export const jobNewCreate = <ThrowOnError extends boolean = false>(options?: Options<JobNewCreateData, ThrowOnError>) => {
 ...
 *
 */
export const jobSetStatusById = <ThrowOnError extends boolean = false>(options?: Options<JobSetStatusByIdData, ThrowOnError>) => {
 ...
 *
 */
export const jobUpdateExisting = <ThrowOnError extends boolean = false>(options?: Options<JobUpdateExistingData, ThrowOnError>) => {
 ...
 *
 */
export const jobSearchByTitle = <ThrowOnError extends boolean = false>(options?: Options<JobSearchByTitleData, ThrowOnError>) => {
 ...
 *
 */
export const jobInterviewPlanGetInfo = <ThrowOnError extends boolean = false>(options?: Options<JobInterviewPlanGetInfoData, ThrowOnError>) => {
 ...
 *
 */
export const jobPostingGetIndividual = <ThrowOnError extends boolean = false>(options?: Options<JobPostingGetIndividualData, ThrowOnError>) => {
 ...
 *
 */
export const jobPostingGetAllPublished = <ThrowOnError extends boolean = false>(options?: Options<JobPostingGetAllPublishedData, ThrowOnError>) => {
    return (options?.client ?? client).post<JobPostingGetAllPublishedResponse2, JobPostingGetAllPublishedError, ThrowOnError>({
        ...options,
        url: '/jobPosting.list'
    });
};
 ...
 *
 */
export const jobPostingUpdateExisting = <ThrowOnError extends boolean = false>(options?: Options<JobPostingUpdateExistingData, ThrowOnError>) => {
    return (options?.client ?? client).post<JobPostingUpdateExistingResponse2, JobPostingUpdateExistingError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const locationCreateHierarchy = <ThrowOnError extends boolean = false>(options?: Options<LocationCreateHierarchyData, ThrowOnError>) => {
 ...
 *
 */
export const locationDetailsById = <ThrowOnError extends boolean = false>(options?: Options<LocationDetailsByIdData, ThrowOnError>) => {
 ...
 *
 */
export const locationGetList = <ThrowOnError extends boolean = false>(options?: Options<LocationGetListData, ThrowOnError>) => {
 ...
 *
 */
export const offerCreateNew = <ThrowOnError extends boolean = false>(options?: Options<OfferCreateNewData, ThrowOnError>) => {
 ...
 *
 */
export const offerGetDetailsById = <ThrowOnError extends boolean = false>(options?: Options<OfferGetDetailsByIdData, ThrowOnError>) => {
 ...
 *
 */
export const offerGetList = <ThrowOnError extends boolean = false>(options?: Options<OfferGetListData, ThrowOnError>) => {
 ...
 *
 */
export const offerStartCreationInstance = <ThrowOnError extends boolean = false>(options?: Options<OfferStartCreationInstanceData, ThrowOnError>) => {
    return (options?.client ?? client).post<OfferStartCreationInstanceResponse2, OfferStartCreationInstanceError, ThrowOnError>({
        ...options,
        url: '/offer.start'
    });
};
 ...
 *
 */
export const offerProcessStartProcessForCandidate = <ThrowOnError extends boolean = false>(options?: Options<OfferProcessStartProcessForCandidateData, ThrowOnError>) => {
    return (options?.client ?? client).post<OfferProcessStartProcessForCandidateResponse2, OfferProcessStartProcessForCandidateError, ThrowOnError>({
        ...options,
 ...
 */
export const openingsGetByUuid = <ThrowOnError extends boolean = false>(options?: Options<OpeningsGetByUuidData, ThrowOnError>) => {
 ...
 */
export const openingsGetList = <ThrowOnError extends boolean = false>(options?: Options<OpeningsGetListData, ThrowOnError>) => {
 ...
 */
export const openingsSearchByIdentifier = <ThrowOnError extends boolean = false>(options?: Options<OpeningsSearchByIdentifierData, ThrowOnError>) => {
    return (options?.client ?? client).post<OpeningsSearchByIdentifierResponse2, OpeningsSearchByIdentifierError, ThrowOnError>({
        ...options,
        url: '/opening.search'
    });
};
 ...
 */
export const openingsCreateInstance = <ThrowOnError extends boolean = false>(options?: Options<OpeningsCreateInstanceData, ThrowOnError>) => {
 ...
 */
export const openingsAddJobAction = <ThrowOnError extends boolean = false>(options?: Options<OpeningsAddJobActionData, ThrowOnError>) => {
 ...
 */
export const openingsRemoveJob = <ThrowOnError extends boolean = false>(options?: Options<OpeningsRemoveJobData, ThrowOnError>) => {
 ...
 */
export const openingsSetState = <ThrowOnError extends boolean = false>(options?: Options<OpeningsSetStateData, ThrowOnError>) => {
 ...
 */
export const openingsSetArchived = <ThrowOnError extends boolean = false>(options?: Options<OpeningsSetArchivedData, ThrowOnError>) => {
 ...
 */
export const openingsUpdateOpening = <ThrowOnError extends boolean = false>(options?: Options<OpeningsUpdateOpeningData, ThrowOnError>) => {
 ...
 *
 */
export const referralCreateNew = <ThrowOnError extends boolean = false>(options?: Options<ReferralCreateNewData, ThrowOnError>) => {
 ...
 *
 */
export const referralFormGetDefaultForm = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
    return (options?.client ?? client).post<ReferralFormGetDefaultFormResponse2, ReferralFormGetDefaultFormError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const sourceGetAll = <ThrowOnError extends boolean = false>(options?: Options<SourceGetAllData, ThrowOnError>) => {
 ...
 *
 */
export const surveyFormDefinitionGetDetailsById = <ThrowOnError extends boolean = false>(options?: Options<SurveyFormDefinitionGetDetailsByIdData, ThrowOnError>) => {
    return (options?.client ?? client).post<SurveyFormDefinitionGetDetailsByIdResponse2, SurveyFormDefinitionGetDetailsByIdError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const surveyFormDefinitionGetAll = <ThrowOnError extends boolean = false>(options?: Options<SurveyFormDefinitionGetAllData, ThrowOnError>) => {
    return (options?.client ?? client).post<SurveyFormDefinitionGetAllResponse2, SurveyFormDefinitionGetAllError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const surveyRequestGenerateUrl = <ThrowOnError extends boolean = false>(options?: Options<SurveyRequestGenerateUrlData, ThrowOnError>) => {
    return (options?.client ?? client).post<SurveyRequestGenerateUrlResponse2, SurveyRequestGenerateUrlError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const surveySubmissionListBySurveyType = <ThrowOnError extends boolean = false>(options?: Options<SurveySubmissionListBySurveyTypeData, ThrowOnError>) => {
    return (options?.client ?? client).post<SurveySubmissionListBySurveyTypeResponse2, SurveySubmissionListBySurveyTypeError, ThrowOnError>({
        ...options,
 ...
 *
 */
export const userGetAshbyUsers = <ThrowOnError extends boolean = false>(options?: Options<UserGetAshbyUsersData, ThrowOnError>) => {
 ...
 *
 */
export const userSearchByEmail = <ThrowOnError extends boolean = false>(options?: Options<UserSearchByEmailData, ThrowOnError>) => {
 ...
 *
 */
export const webhookCreateSetting = <ThrowOnError extends boolean = false>(options?: Options<WebhookCreateSettingData, ThrowOnError>) => {
 ...
 *
 */
export const webhookUpdateSetting = <ThrowOnError extends boolean = false>(options?: Options<WebhookUpdateSettingData, ThrowOnError>) => {
 ...
 *
 */
export const webhookRemoveSetting = <ThrowOnError extends boolean = false>(options?: Options<WebhookRemoveSettingData, ThrowOnError>) => {
