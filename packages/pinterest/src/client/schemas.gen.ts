...
export const AdCommonSchema = {
    ...
    properties: {
        ...
        customizable_cta_type: {
            ...
            example: 'LEARN_MORE',
            nullable: true,
            enum: ['GET_OFFER', 'LEARN_MORE', 'ORDER_NOW', 'SHOP_NOW', 'SIGN_UP', 'SUBSCRIBE', 'BUY_NOW', 'CONTACT_US', 'GET_QUOTE', 'VISIT_SITE', 'APPLY_NOW', 'BOOK_NOW', 'REQUEST_DEMO', 'REGISTER_NOW', 'FIND_A_DEALER', 'ADD_TO_CART', 'WATCH_NOW', 'READ_MORE', null]
        },
        quiz_pin_data: {
            type: 'object',
            allOf: [
...
export const AdsAnalyticsCampaignTargetingTypeSchema = {
    ...
    example: 'APPTYPE',
    enum: ['KEYWORD', 'APPTYPE', 'GENDER', 'LOCATION', 'PLACEMENT', 'COUNTRY', 'TARGETED_INTEREST', 'PINNER_INTEREST', 'AUDIENCE_INCLUDE', 'GEO', 'AGE_BUCKET', 'REGION', 'CREATIVE_TYPE', 'AGE_BUCKET_AND_GENDER']
} as const;
...
export const BusinessAccessRoleSchema = {
    ...
    example: 'ADMIN',
    enum: ['OWNER', 'ADMIN', 'ANALYST', 'SOS_READER', 'FINANCE_MANAGER', 'AUDIENCE_MANAGER', 'CAMPAIGN_MANAGER', 'CATALOGS_MANAGER', 'RESTRICTED_OWNER', 'PROFILE_MANAGER', 'PROFILE_PUBLISHER', 'RESOURCE_PINNER_LIST_OWNER', 'RESOURCE_PINNER_LIST_READER', 'BIZ_PINNER_LIST_SHARER', 'RESOURCE_CONVERSION_TAGS_READER']
} as const;
...
export const CatalogsCreativeAssetsFeedSchema = {
    ...
    allOf: [
        ...
        },
        {
            ...
            required: ['credentials', 'format', 'location', 'name', 'preferred_processing_schedule', 'status', 'catalog_type', 'default_locale', 'default_currency', 'default_country', 'catalog_id']
        }
    ]
} as const;
...
export const CatalogsHotelFeedSchema = {
    ...
    allOf: [
        ...
        },
        {
            ...
            required: ['credentials', 'format', 'location', 'name', 'preferred_processing_schedule', 'status', 'catalog_type', 'default_locale', 'default_currency', 'catalog_id']
        }
    ]
} as const;
...
export const CatalogsRetailFeedSchema = {
    ...
    allOf: [
        ...
        },
        {
            ...
            required: ['credentials', 'default_availability', 'default_country', 'default_currency', 'default_locale', 'format', 'location', 'name', 'preferred_processing_schedule', 'status', 'catalog_type']
        }
    ]
} as const;
...
`,
                    ...
                    custom_data: {
                        ...
                        properties: {
                            ...
                            opt_out_type: {
                                description: 'Flags for different privacy rights laws to opt out users of sharing personal information. Values should be comma separated. Please follow the <a href="https://help.pinterest.com/en/business/article/limited-data-processing" target="_blank">Help Center</a> and <a href="/docs/api-features/conversion-overview/" target="_blank">dev site</a> for specific opt_out_type set up.',
                                example: 'LDP',
                                type: 'string',
                                nullable: true
                            },
...
export const CreativeTypeSchema = {
    ...
    enum: ['REGULAR', 'VIDEO', 'SHOPPING', 'CAROUSEL', 'MAX_VIDEO', 'SHOP_THE_PIN', 'COLLECTION', 'IDEA', 'SHOWCASE', 'QUIZ'],
    example: 'REGULAR',
    title: 'CreativeType'
} as const;
    ...
    allOf: [
        {
            ...
            properties: {
                ...
                refresh_on: {
                    description: 'Setting this field to <code>true</code> will add a new refresh token to your 200 response, as well as the refresh_token_expires_in and refresh_token_expires_at fields. To see the structure of this payload, set the 200 response_type to "everlasting_refresh".',
                    type: 'boolean'
                }
            },
...
export const ObjectiveTypeSchema = {
    ...
    enum: ['AWARENESS', 'CONSIDERATION', 'VIDEO_VIEW', 'WEB_CONVERSION', 'CATALOG_SALES', 'WEB_SESSIONS', 'VIDEO_COMPLETION']
} as const;
...
export const PermissionsSchema = {
    type: 'string',
    enum: ['ADMIN', 'ANALYST', 'FINANCE_MANAGER', 'AUDIENCE_MANAGER', 'CAMPAIGN_MANAGER', 'CATALOGS_MANAGER', 'PROFILE_PUBLISHER']
} as const;
...
export const PermissionsWithOwnerSchema = {
    type: 'string',
    enum: ['ADMIN', 'ANALYST', 'FINANCE_MANAGER', 'AUDIENCE_MANAGER', 'CAMPAIGN_MANAGER', 'CATALOGS_MANAGER', 'CATALOGS_VIEWER', 'PROFILE_PUBLISHER', 'OWNER']
} as const;
...
export const PinSchema = {
    ...
    properties: {
        ...
        is_standard: {
            description: 'Whether the Pin is standard or not. See documentation on <a href="/docs/api-features/content-overview/">Changes to Pin creation</a> for more information.',
            type: 'boolean'
        },
        has_been_promoted: {
...
export const PinMediaWithVideoSchema = {
    ...
    example: {
        ...
        cover_image_url: 'https://i.pinimg.com/videos/thumbnails/originals/a8/b9/38/a8b938b1dacc523054a6bac201e9f1d2.0000001.jpg',
        duration: 14000,
        height: 1064,
        width: 1280
    }
...
export const RoleSchema = {
    ...
    example: 'ADMIN',
    enum: ['UNKNOWN', 'OWNER', 'ADMIN', 'ANALYST', 'SOS_READER', 'FINANCE_MANAGER', 'AUDIENCE_MANAGER', 'CAMPAIGN_MANAGER', 'CATALOGS_MANAGER', 'RESTRICTED_OWNER', 'PROFILE_MANAGER', 'PROFILE_PUBLISHER', 'RESOURCE_PINNER_LIST_OWNER', 'RESOURCE_PINNER_LIST_READER', 'BIZ_PINNER_LIST_SHARER', 'RESOURCE_CONVERSION_TAGS_READER']
} as const;
...
export const SSIOCreateInsertionOrderRequestSchema = {
    ...
    allOf: [
        ...
        {
            type: 'object',
            required: ['order_line_type', 'start_date', 'po_number', 'pmp_id', 'order_name', 'media_contact_firstname', 'media_contact_lastname', 'media_contact_email', 'currency_info', 'billto_company_id', 'billto_business_address_id', 'billto_billing_address_id', 'billing_contact_firstname', 'billing_contact_lastname', 'billing_contact_email', 'accepted_terms_id'],
            properties: {
                accepted_terms_time: {
