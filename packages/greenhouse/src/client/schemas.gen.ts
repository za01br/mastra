...
export const jobSchema = {
    ...
    required: ['id', 'name', 'requisition_id', 'notes', 'confidential', 'status', 'created_at', 'opened_at', 'closed_at', 'updated_at', 'is_template', 'copied_from_id', 'departments', 'offices', 'openings', 'custom_fields', 'keyed_custom_fields', 'hiring_team'],
    additionalProperties: {}
} as const;
...
export const keyedCustomFieldsSchema = {
    type: 'object',
    properties: {
        name: {
            type: 'string'
...
export const offerSchema = {
    ...
    required: ['id', 'version', 'application_id', 'job_id', 'candidate_id', 'opening', 'created_at', 'updated_at', 'sent_at', 'resolved_at', 'starts_at', 'status', 'custom_fields', 'keyed_custom_fields']
} as const;
...
export const candidateSchema = {
    ...
    required: ['id', 'first_name', 'last_name', 'company', 'title', 'created_at', 'updated_at', 'last_activity', 'is_private', 'photo_url', 'application_ids', 'can_email', 'tags', 'attachments', 'phone_numbers', 'addresses', 'email_addresses', 'website_addresses', 'social_media_addresses', 'recruiter', 'coordinator', 'applications'],
    additionalProperties: {},
    description: `
...
export const applicationSchema = {
    ...
    required: ['id', 'candidate_id', 'prospect', 'applied_at', 'rejected_at', 'last_activity_at', 'location', 'source', 'credited_to', 'rejection_reason', 'rejection_details', 'jobs', 'job_post_id', 'status', 'current_stage', 'answers', 'prospective_office', 'prospective_department', 'prospect_detail', 'custom_fields', 'keyed_custom_fields', 'attachments']
} as const;
