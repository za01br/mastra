...
export const AuthUserSchema = {
    ...
    properties: {
        ...
        softBlock: {
            ...
            properties: {
                ...
                reason: {
                    enum: ['FAIR_USE_LIMITS_EXCEEDED', 'ENTERPRISE_TRIAL_ENDED', 'BLOCKED_FOR_PLATFORM_ABUSE', 'UNPAID_INVOICE', 'SUBSCRIPTION_EXPIRED', 'SUBSCRIPTION_CANCELED'],
                    type: 'string'
                }
            },
    ...
    required: ['createdAt', 'softBlock', 'billing', 'resourceConfig', 'stagingPrefix', 'hasTrialAvailable', 'id', 'email', 'name', 'username', 'avatar'],
    type: 'object'
} as const;
                    ...
                    properties: {
                        ...
                        joinedFrom: {
                            properties: {
                                ...
                                origin: {
                                    enum: ['import', 'saml', 'mail', 'link', 'teams', 'github', 'gitlab', 'bitbucket', 'dsync', 'feedback', 'organization-teams'],
                                    type: 'string'
                                },
                                repoId: {
                                    type: 'string'
            ...
            items: {
                ...
                properties: {
                    ...
                    type: {
                        ...
                        enum: ['target', 'author', 'bitbucket_login', 'bold', 'deployment_host', 'dns_record', 'git_link', 'github_login', 'gitlab_login', 'hook_name', 'integration', 'edge-config', 'link', 'project_name', 'scaling_rules', 'env_var_name', 'system'],
                        examples: ['author'],
                        type: 'string'
                    }
                },
