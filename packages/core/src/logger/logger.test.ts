...
import { BaseLogMessage, createLogger, combineLogger, Logger, LogLevel, noopLogger, RegisteredLogger } from './';
...
describe('Logger Utilities', () => {
  ...
  describe('MultiLogger', () => {
    it('should log to multiple loggers', async () => {
      ...
      const multiLogger = combineLogger([
    ...
    it('should handle cleanup of all loggers', async () => {
      ...
      const multiLogger = combineLogger([createLogger({ type: 'CONSOLE' }), customLogger]);
