...
> {
  ...
  createModelDef({
    ...
    if (model.type === 'openai') {
      ...
      this.#log(LogLevel.INFO, `Initializing Anthropic model ${
      ...
      this.#log(LogLevel.INFO, `Initializing Perplexity model ${
      ...
      this.#log(LogLevel.INFO, `Initializing Fireworks model ${
      ...
      this.#log(LogLevel.INFO, `Initializing Anthropic Vertex model ${
        model.name || 'claude-3-5-sonnet@20240620'
      }`);
