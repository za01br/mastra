...
export function SidebarItems({
  ...
  return (
    ...
    >
      {open ? (
        <div
          className={`w-1 bg-mastra-border-1 cursor-col-resize h-full hover:w-2 hover:bg-mastra-border-2 active:bg-mastra-border-3 transition-colors absolute inset-y-0 -left-1 -right-1 z-10
