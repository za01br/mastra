...
export const DeleteWorkflowActionDropdownButton = ({
  action,
  deleteOnlyBlock,
}: DeleteWorkflowActionDropdownButtonProps) => {
  const [isDialogOpen, setIsDialogOpen] = useState(false);
  const { removeAction, selectedBlock, setSelectedBlock } = useWorkflowContext();
