...
function App() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      <header className="sticky top-0 z-50 flex items-center justify-between w-full h-12 px-4 border-b bg-white">
        <div className="flex items-center gap-2">
          <div className="bg-gray-100 flex size-[25px] shrink-0 select-none items-center justify-center rounded-md border shadow-sm">
