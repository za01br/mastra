...
Documents: \`.csv\` \`.doc\` \`.docx\` \`.epub\` \`.odt\` \`.pdf\` \`.ppt\` \`.pptx\` \`.tsv\` \`.xlsx\` \`.xls\`.`
        ...
        partition: {
            type: 'string',
            title: 'Partition',
            description: 'An optional partition identifier. Documents can be scoped to a partition. A partition is created any time a document is created or moved to a new partition.'
        }
    },
    type: 'object',
    required: ['file'],
...
export const CreateInstructionParamsSchema = {
    properties: {
            ...
            examples: [
                {
                    ...
                    properties: {
                        ...
                        toppings: {
                            items: {
                                enum: ['pepperoni', 'mushrooms', 'onions', 'sausage', 'bacon', 'extra cheese', 'black olives', 'green peppers', 'pineapple', 'spinach'],
                                type: 'string'
                            },
                            type: 'array',
                            uniqueItems: true
        ...
        partition: {
            type: 'string',
            title: 'Partition',
            description: 'An optional partition identifier. Instructions can be scoped to a partition. An instruction that defines a partition will only be executed for documents in that partition.',
            examples: [
                null
            ]
        }
...
export const RetrieveParamsSchema = {
    properties: {
        ...
        partition: {
            type: 'string',
            title: 'Partition',
            description: 'The partition to scope a retrieval to. If omitted, the retrieval will be scoped to the default partition, which includes any documents that have not been created in or moved to a partition.',
            examples: [
                null
            ]
        }
