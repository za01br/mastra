...
export type Collection = Node & Subscribable & {
...
/** A tag. */
export type Tag = Node & Subscribable & {
  __typename?: 'Tag';
  /** Identifies the date and time when the object was created. */
  createdAt: Scalars['DateTime']['output'];
...
export type UnknownUser = Actor & Node & {
...
export type User = Actor & Node & Subscribable & Viewer & {
  __typename?: 'User';
...
export type SubscribeMutation = { __typename?: 'Mutation', createWebhook?: { __typename?: 'CreateWebhookPayload', viewer: { __typename?: 'User', id: string }, webhook?: { __typename?: 'Webhook', id: string, enabled: boolean } | null, errors: Array<{ __typename?: 'NotFoundError', message: string, path?: Array<string> | null } | { __typename?: 'PermissionError', message: string, path?: Array<string> | null } | { __typename?: 'ValidationError', message: string, path?: Array<string> | null }> } | null };
...
export type UnsubscribeMutation = { __typename?: 'Mutation', deleteWebhook?: { __typename?: 'DeleteWebhookPayload', viewer: { __typename?: 'User', id: string }, errors: Array<{ __typename?: 'NotFoundError', message: string, path?: Array<string> | null } | { __typename?: 'PermissionError', message: string, path?: Array<string> | null } | { __typename?: 'ValidationError', message: string, path?: Array<string> | null }> } | null };
...
export type CurrentChannelQuery = { __typename?: 'Query', channel: { __typename?: 'Channel', subdomain: string, user?: { __typename?: 'User', id: string, channelRole: ChannelRole } | null } };
...
export type VideoQuery = { __typename?: 'Query', node?: { __typename: 'ActionItem' } | { __typename: 'Chapter' } | { __typename: 'Collection' } | { __typename: 'Comment' } | { __typename: 'Group' } | { __typename: 'Highlight' } | { __typename: 'QueueItem' } | { __typename: 'Tag' } | { __typename: 'Tagging' } | { __typename: 'UnknownUser' } | { __typename: 'User' } | { __typename: 'Video', id: string, title: string, description?: string | null, presentedAt: any, duration?: number | null, url: any, thumbnailUrl?: any | null, attendeesInfo: Array<any> } | { __typename: 'VideoAttachment' } | { __typename: 'Webhook' } | { __typename: 'ZoomChat' } | { __typename: 'ZoomVideo' } | null };
...
export type WebhookQuery = { __typename?: 'Query', node?: { __typename?: 'ActionItem' } | { __typename?: 'Chapter' } | { __typename?: 'Collection' } | { __typename?: 'Comment' } | { __typename?: 'Group' } | { __typename?: 'Highlight' } | { __typename?: 'QueueItem' } | { __typename?: 'Tag' } | { __typename?: 'Tagging' } | { __typename?: 'UnknownUser' } | { __typename?: 'User' } | { __typename?: 'Video' } | { __typename?: 'VideoAttachment' } | { __typename: 'Webhook', id: string, enabled: boolean, disabledReason?: WebhookDisabledReason | null } | { __typename?: 'ZoomChat' } | { __typename?: 'ZoomVideo' } | null };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    Subscribe(variables: SubscribeMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<SubscribeMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<SubscribeMutation>(SubscribeDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'Subscribe', 'mutation', variables);
    },
    Unsubscribe(variables: UnsubscribeMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<UnsubscribeMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<UnsubscribeMutation>(UnsubscribeDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'Unsubscribe', 'mutation', variables);
    },
    CurrentChannel(variables: CurrentChannelQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CurrentChannelQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<CurrentChannelQuery>(CurrentChannelDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CurrentChannel', 'query', variables);
    },
    Video(variables: VideoQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<VideoQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<VideoQuery>(VideoDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'Video', 'query', variables);
    },
    CurrentViewer(variables?: CurrentViewerQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CurrentViewerQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<CurrentViewerQuery>(CurrentViewerDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CurrentViewer', 'query', variables);
    },
    Webhook(variables: WebhookQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<WebhookQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<WebhookQuery>(WebhookDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'Webhook', 'query', variables);
    }
  };
}
