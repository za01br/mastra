        ...
        <div className="space-y-1">
          {editTrigger ? (
            <>
              ...
              <p className="text-kpl-el-6 text-[11px]">Change the event that starts the automation</p>
            </>
          ) : (
            <>
              <h1 className="text-xs">Trigger</h1>
              <p className="text-kpl-el-3 text-[11px]">Pick an event to start automation</p>
            </>
          )}
        </div>
