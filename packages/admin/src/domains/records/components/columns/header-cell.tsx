  ...
  return (
    ...
    >
      <div className="justify-left flex w-[70%] items-center">
        {icon && <Icon name={icon} className="text-arkw-el-3 inline-block h-4 w-4 flex-shrink-0" />}
        <span className="text-arkw-el-6 ml-2 overflow-hidden text-ellipsis whitespace-nowrap font-normal">
          {header}
        </span>
      </div>
    </div>
