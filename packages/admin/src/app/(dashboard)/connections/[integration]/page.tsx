    ...
    <section>
      ...
      <div className="mx-auto max-w-[40em] flex flex-col gap-8">
        <div className="flex w-full gap-3 mt-4 pb-4">
          <div className="flex p-2 w-80 flex-col gap-2 border-[0.5px] border-kpl-border-1 rounded bg-kpl-bg-3">
            <div className="flex flex-col gap-1">
              <p className="flex items-center gap-1">
                <svg
                  ...
                  className="text-kpl-el-6 h-4 w-4"
                >
                  <path
                    className="db-icon"
            ...
            <button className="text-xs w-fit bg-kpl-bg-4/50 hover:bg-kpl-bg-4/80  rounded px-3 hover:text-kpl-el-6 transition-all text-kpl-el-3 p-1">
              View all{' '}
            </button>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          <div className="border-b pb-2  border-kpl-border-1">
            <h1 className="text-xl font-medium ">Installation</h1>
            <span className="text-xs text-kpl-el-3">
              Allow users create a <span className="text-kpl-el-6">connection</span> to this integration
            </span>
          </div>

          <div className="flex flex-col gap-2">
            <div>
              <span className="bg-kpl-bg-4 inline-block rounded-sm text-center w-6">1</span>
