...
export const postingSchema = {
    ...
    required: ['id', 'text', 'createdAt', 'updatedAt', 'user', 'owner', 'hiringManager', 'confidentiality', 'categories', 'content', 'country', 'tags', 'state', 'distributionChannels', 'reqCode', 'requisitionCodes', 'salaryDescription', 'salaryDescriptionHtml', 'salaryRange', 'urls', 'workplaceType'],
...
export const opportunitySchema = {
    ...
    required: ['id', 'name', 'headline', 'contact', 'emails', 'phones', 'confidentiality', 'location', 'links', 'createdAt', 'updatedAt', 'lastInteractionAt', 'lastAdvancedAt', 'snoozedUntil', 'archivedAt', 'archiveReason', 'stage', 'stageChanges', 'owner', 'tags', 'sources', 'origin', 'sourcedBy', 'applications', 'followers', 'urls', 'dataProtection', 'isAnonymized'],
    description: `
