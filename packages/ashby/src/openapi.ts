                ...
                properties: {
                  ...
                  data: {
                    ...
                    properties: {
                      interviewSchedule: {
                        type: 'object';
                        required: ['id', 'status', 'applicationId', 'interviewStageId'];
                        properties: {
                          id: {
                            type: 'string';
                  ...
                  data: {
                    ...
                    properties: {
                      job: {
                        ...
                        required: ['id', 'title', 'confidential', 'status', 'employmentType', 'updatedAt'];
                      };
                    };
                  };
                };
                      ...
                      jobPosting: {
                        ...
                        properties: {
                          ...
                          locationIds: {
                            ...
                            required: ['primaryLocationId', 'secondaryLocationId'];
                          };
                          employmentType: {
                            type: 'string';
                            enum: ['FullTime', 'PartTime', 'Intern', 'Contract', 'Temporary'];
                    ...
                    properties: {
                      offer: {
                        ...
                        properties: {
                          ...
                          acceptanceStatus: {
                            type: 'string';
                            enum: ['Accepted', 'Declined', 'Pending', 'Created', 'Cancelled'];
                          };
                          offerStatus: {
                            type: 'string';
                            enum: [
                        ...
                        required: ['id', 'applicationId', 'acceptanceStatus'];
                      };
                    };
                  };
                };
                  ...
                  data: {
                    ...
                    properties: {
                      surveySubmission: {
                        ...
                        required: ['id', 'submittedAt', 'candidateId', 'surveyType'];
                      };
                    };
                  };
                };
